...
export const darkTheme: DeepPartial<Theme> = {
  styles: {
    ...
    "--em-buttonicon-background--primary--active":
      "var(--em-sem-text--neutral)",
    ...
    "--em-buttonicon-padding-left-right--medium":
      "var(--em-core-spacing--0300)",
    "--em-buttonicon-padding-left-right--small": "var(--em-core-spacing--0150)",
    "--em-buttonicon-padding-top-bottom--medium":
      "var(--em-core-spacing--0300)",
    ...
    "--em-card-feedback-title-font-weight":
    ...
    "--em-field-feedback-error-font-weight":
      "var(--em-core-font-weight--medium)",
    ...
    "--em-piechart-donut-label-font-weight":
      "var(--em-core-font-weight--medium)",
    ...
    "--em-piechart-donut-number-font-weight":
      "var(--em-core-font-weight--bold)",
    ...
    "--em-selectfield-content-border-radius":
      "var(--em-core-border-radius--300)",
    ...
    "--em-selectfield-item-background--active":
      "var(--em-sem-background--light)",
    ...
    "--em-selectfield-item-icon-color--selected":
    ...
    "--em-selectfield-item-label-left-color--selected":
      "var(--em-sem-text--inverted)",
    "--em-selectfield-item-label-left-font-size":
      "var(--em-core-font-size--xs)",
    ...
    "--em-selectfield-item-label-right-color--selected":
      "var(--em-sem-text--inverted)",
    "--em-selectfield-item-label-right-font-size":
      "var(--em-core-font-size--xs)",
    ...
    "--em-selectfield-trigger-border-radius":
      "var(--em-core-border-radius--200)",
    ...
    "--em-selectfield-trigger-font-weight":
      "var(--em-core-font-weight--medium)",
    ...
    "--em-textfield-feedback-font-weight":
      "var(--em-core-font-weight--regular)",
